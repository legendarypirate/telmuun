...
db.bulks = require("./bulk.model.js")(sequelize, Sequelize);
...
db.generals = require("./general.model.js")(sequelize, Sequelize);
...
db.users.hasMany(db.generals, {
  foreignKey: 'user_id',
  as: 'generals', // user.generals
});

// General belongs to a user
db.generals.belongsTo(db.users, {
  foreignKey: 'user_id',
  as: 'user', // general.user
});
...
db.delivery_items.belongsTo(db.goods, {
  foreignKey: 'good_id',
  as: 'good',   // alias for the Good model inside DeliveryItem
});
...
// Delivery has many DeliveryItems
